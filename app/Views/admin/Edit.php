                        ...
                        <div class="card d-flex my-5" style="rgba(0, 0, 0, 0.25);">
                            <div class="row">
                                ...
                                <div class="col px-4 pt-3" style="margin-left: -90px;">
                                    <form action="<?= base_url('admin/update/' . $petugas['id_petugas']) ?>" method="post"
                                        enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <input type="text" class="form-control" name="nama_petugas"
                                                placeholder="Nama Petugas" value="<?= $petugas['nama_petugas'] ?>"
                                                aria-label="nama_petugas" aria-describedby="basic-addon1">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <input type="text" class="form-control" name="telepon"
                                                value="<?= $petugas['telepon'] ?>" placeholder="Telepon"
                                                aria-label="telepon" aria-describedby="basic-addon1">
                                        </div>
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col" style="">
